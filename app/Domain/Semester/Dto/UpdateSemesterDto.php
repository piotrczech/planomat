...
namespace App\Domain\Semester\Dto;
...
final class UpdateSemesterDto extends Data
{
    ...
    public static function messages(): array
    {
        ...
        return [
            ...
            'id.exists' => __('admin_settings.semester_manager.validation.id_exists'),
