...
>
    <flux:heading
        ...
        id="form-heading"
    >
        {{ __('consultation::consultation.New part-time consultation') }}
    </flux:heading>

    <flux:text class="mb-8">
        <p>
            {{ __('consultation::consultation.New part-time consultation description') }}
        </p>
    </flux:text>
        ...
        <div class="flex justify-end items-center">
            ...
            >
                <span wire:loading.remove wire:target="addConsultation">
                    {{ __('consultation::consultation.Add part-time consultation') }}
                </span>
