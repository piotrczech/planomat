<x-layouts.app :title="__('admin_settings.users.Manage Users')">
    <flux:main>
        <div class="max-w-7xl mx-auto py-8 md:py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="text-sm text-neutral-500 dark:text-neutral-400 space-y-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1">
                    {!! __('admin_settings.users.Manage Users Page Description') !!}
                </div>
            </div>

            {{-- Livewire User Manager Component --}}
            <livewire:admin.settings.user-manager :filter-role="\App\Domain\Enums\RoleEnum::SCIENTIFIC_WORKER" />
