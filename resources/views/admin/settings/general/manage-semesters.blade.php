<x-layouts.app :title="__('admin_settings.Manage Semesters')">
    <flux:main>
        <div class="max-w-7xl mx-auto py-8 md:py-12 px-4 sm:px-6 lg:px-8">
            ...
            <flux:heading class="!text-2xl sm:!text-3xl font-bold text-neutral-800 dark:text-neutral-100 mb-2">
                <flux:icon name="calendar-days" class="w-8 h-8 mr-2 inline-block align-text-bottom" />
                {{ __('admin_settings.Manage Semesters') }}
            </flux:heading>
            <flux:text size="sm" class="text-neutral-500 dark:text-neutral-400 mb-8">
                {{ __('admin_settings.Manage Semesters Page Description') }}
            </flux:text>

            <livewire:admin.settings.semester-manager />
