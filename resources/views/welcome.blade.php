    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-xl">planoMAT</h1>
                <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">Nowoczesny system wspierający planowanie dydaktyczne
                    dla pracowników uczelni.</p>

                <h2 class="mb-1 font-medium text-lg">Opis projektu</h2>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Celem projektu jest stworzenie intuicyjnego i
                    wydajnego systemu wspierającego planowanie zajęć dydaktycznych. System realizowany jest jako projekt
                    open-source i obejmuje dwa główne moduły funkcjonalne:</p>
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            <span class="font-medium">Moduł Dezyderaty</span>
                        </span>
                    </li>
                    <li
                        ...
                        <span>
                            <span class="font-medium">Moduł Konsultacje</span>
                        </span>
                    </li>
                </ul>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="https://github.com/piotrczech/planomat" target="_blank"
