    ...
    <div class="bg-white dark:bg-neutral-800/70 shadow-md sm:rounded-xl">
        <div class="p-6 border-b border-neutral-200 dark:border-neutral-700">
            <flux:heading level="3" size="md">
                {{ __('admin_settings.semester_manager.Semester List') }}
            </flux:heading>
            <flux:text size="sm" class="mt-1 text-neutral-500 dark:text-neutral-400">
                {{ __('admin_settings.semester_manager.Semester List Description') }}
            </flux:text>
        </div>

        <div class="p-6">
            {{-- Tutaj znajdzie się tabela z listą semestrów oraz przycisk do dodawania nowego semestru --}}
            ...
            <div class="border border-neutral-200 dark:border-neutral-700 rounded-lg p-10 text-center">
                ...
                <flux:text class="text-neutral-500 dark:text-neutral-400">
                    {{ __('admin_settings.semester_manager.Semester table placeholder') }}
                </flux:text>
            </div>

            {{-- Modal do dodawania/edycji semestru (na razie ukryty lub jako placeholder) --}}
