            ...
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <flux:heading level="3" id="modal-title" class="text-lg font-medium leading-6 text-neutral-900 dark:text-neutral-100">
                        {{ __('admin_settings.course_manager.Delete Course') }}
                    </flux:heading>
                    <div class="mt-2">
                        <flux:text size="sm" class="text-neutral-500 dark:text-neutral-400">
                            {{ __('admin_settings.course_manager.Are you sure you want to delete the course') }} <strong class="text-neutral-700 dark:text-neutral-200">{{ $courseName }}</strong>? {{ __('admin_settings.course_manager.This action cannot be undone.') }}
                        </flux:text>
                    </div>
                </div>
            </div>
